...
The [Large Synoptic Sky Survey](https://www.lsst.org "LSST Homepage")
] (LSST) is a next-generation astronomical survey that will repeatedly survey the entire southern sky to unprecedented depths. A major part of the project is the development of a software pipeline (known as the [LSST stack](https://github.com/lsst "LSST stack github")) that will process the raw data from the raft of CCDs that form the LSST's detector.
